...
class Pluggable {
     ...
     *
     * Some WordPress public static functionality is based on the current user and not based on
     ...
     * @since 2.0.3
     */
    public static function wp_set_current_user($id, $name = '')
    {
        global $current_user;
     ...
     *
     */
    public static function wp_get_current_user()
    {
     ...
     *
     */
    public static function cache_users($user_ids)
    {
        global $wpdb;
    ...
    public static function wp_mail($to, $subject, $message, $headers = '', $attachments = array())
    {
        ...
        if (empty($headers)) {
            ...
            if (!is_array($headers)) {
                // Explode the headers out, so this public static function can take both
     ...
     *
     */
    public static function wp_validate_auth_cookie($cookie = '', $scheme = '')
    {
     ...
     * @since 2.5.0
     */
    public static function wp_generate_auth_cookie($user_id, $expiration, $scheme = 'auth', $token = '')
    {
     ...
     *
     */
    public static function wp_parse_auth_cookie($cookie = '', $scheme = '')
    {
        if (empty($cookie)) {
            switch ($scheme) {
                case 'auth':
     ...
     * @since 2.5.0
     */
    public static function wp_clear_auth_cookie()
    {
        /**
     ...
     *
     * For more information on this and similar theme public static functions, check out
     ...
     * @since 1.5.1
     */
    public static function wp_redirect($location, $status = 302, $x_redirect_by = 'WordPress')
    {
        global $is_IIS;
     ...
     *
     */
    public static function wp_sanitize_redirect($location)
    {
        $regex = '/
		(
     ...
     *
     */
    public static function _wp_sanitize_utf8_in_redirect($matches)
    {
     ...
     *
     */
    public static function wp_safe_redirect($location, $status = 302, $x_redirect_by = 'WordPress')
    {
     ...
     *
     */
    public static function wp_validate_redirect($location, $default = '')
    {
    ...
    public static function wp_new_user_notification($user_id, $deprecated = null, $notify = '')
    {
        ...
        if (empty($wp_hasher)) {
            require_once ABSPATH . WPINC . '/PasswordHash.php';
     ...
     *
     */
    public static function wp_nonce_tick()
    {
        /**
     ...
     *
     */
    public static function wp_hash($data, $scheme = 'auth')
    {
        $salt = wp_salt($scheme);
     ...
     *
     * For integration with other applications, this public static function can be overwritten to
     ...
     * and the public static function compares the plain text password when encrypted similarly
    ...
    public static function wp_check_password($password, $hash, $user_id = '')
    {
        ...
        if (strlen($hash) <= 32) {
            $check = Compat::hash_equals($hash, md5($password));
            if ($check && $user_id) {
                // Rehash using new hash.
                Pluggable::wp_set_password($password, $user_id);
             ...
             *
             */
            return Pluggable::apply_filters('check_password', $check, $password, $hash, $user_id);
        }
     ...
     * than similar native PHP public static functions like `rand()` or `mt_rand()`.
     *
     ...
     *
     */
    public static function wp_generate_password($length = 12, $special_chars = true, $extra_special_chars = false)
    {
     ...
     * @staticvar bool $use_random_int_public static functionality
     *
     */
    public static function wp_rand($min = 0, $max = 0)
    {
        global $rnd_value;
     ...
     * instead use the other package password checking algorithm.
     *
     * Please note: This public static function should be used sparingly and is really only meant for single-time
     ...
     *
     */
    public static function wp_text_diff($left_string, $right_string, $args = null)
    {
        $defaults = array(
            'title' => '',
            'title_left' => '',
